...
int main(void)
{
	...
	Matrix_Copy(t1, Transformation_Translation(0, 0, 5));
	Matrix_Copy(t2, Transformation_RotationY(M_PI/4));
	Matrix_Copy(m1, Matrix_Multiply(t1, t2));
	Matrix_Copy(t3, Transformation_RotationX(M_PI/2));
	Matrix_Copy(t4, Transformation_Scale(10, 0.01, 10));
	Matrix_Copy(m2, Matrix_Multiply(t3, t4));
	Matrix_Destroy(&t3);
	Matrix_Destroy(&t4);
	...
	Matrix_Copy(t1, Transformation_Translation(1.5, 0.5, -0.5));
	Matrix_Copy(t2, Transformation_Scale(0.5, 0.5, 0.5));
	...
	Matrix_Copy(t1, Transformation_Translation(-1.5, 0.33, -0.75));
	Matrix_Copy(t2, Transformation_Scale(0.33, 0.33, 0.33));
