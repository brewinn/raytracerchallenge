...
TEST_SETUP(Sphere) { sphere = Sphere_Create(); }

TEST_TEAR_DOWN(Sphere) { Sphere_Destroy(&sphere); }

TEST(Sphere, SphereCreateReturnsSphere) { TEST_ASSERT_NOT_NULL(sphere); }
...
TEST_SETUP(SphereNormals) { sphere = Sphere_Create(); }

TEST_TEAR_DOWN(SphereNormals) { Sphere_Destroy(&sphere); }
...
TEST_SETUP(SphereTransformation) { sphere = Sphere_Create(); }
...
TEST_SETUP(TransformedSphereIntersections) { sphere = Sphere_Create(); }
