...
TEST_SETUP(Canvas) { canvas = Canvas_Create(10, 10); }

TEST_TEAR_DOWN(Canvas) { Canvas_Destroy(canvas); }
...
static void ReadLine(FILE *file, char *line) { fscanf(file, "%[^\n] ", line); }
...
TEST(CanvasToPPM, WriteToPpmCreatesFile) { TEST_ASSERT_NOT_NULL(file); }
...
TEST(CanvasWithColor, WriteToPpmSplitsLongLines) {
  char *line1 =
      "191 193 196 191 193 196 191 193 196 191 193 196 191 193 196 191 193";
